...
public class MethodesIaDur {
    public static int[][] jouerTourIA(int[][] plateau, int[] derniereCoordonnees) {
        ...
        int[][] tabcarre = new int[plateau.length][plateau[0].length];
        int cpt =0;
        int[][] tabbattonet = new int[plateau.length][plateau[0].length];
        int[][] tabbattonetcoins = new int[plateau.length][plateau[0].length];
        ...
        if (!aTrouveUnBonMouvement) {
            ...
            for (int ligne = 0; ligne < plateau.length; ligne++) {
                for (int colonne = 0; colonne < plateau[ligne].length; colonne++) {
                    ...
                    if (ligne % 2 != colonne % 2 && plateau[ligne][colonne] == 0) {
                        ...
                        int carreForme = testcarreForme(plateau, ligne, colonne, 4); // Supposons que 4 repr�sente l'IA
                        plateau[ligne][colonne] = 0; // Annuler le coup temporaire

                        // Si un carr� est form�, choisir ce mouvement
                        if (carreForme == 4) {
                            cpt++;
                            tabcarre[ligne][colonne] = 4;
                        }
                    }
                }
            ...
            if (cpt!=0) {
                ...
                } while (tabcarre[meilleureOptionLigne][meilleureOptionColonne]!=4);
        ...
        if (!aTrouveUnBonMouvement) {
            ...
            for (int ligne = 0; ligne < plateau.length; ligne++) {
                for (int colonne = 0; colonne < plateau[ligne].length; colonne++) {
                    // V�rifier uniquement les cases o� l'IA peut jouer
                    if (ligne % 2 != colonne % 2 && plateau[ligne][colonne] == 0) {
                        if (peutPlacerBatonnet(plateau, ligne, colonne) < 2) {
                            if (peutPlacerBatonnetHaut(plateau, ligne, colonne) < 2 && peutPlacerBatonnetBas(plateau, ligne, colonne) < 2 &&
                                    peutPlacerBatonnetGauche(plateau, ligne, colonne) < 2 && peutPlacerBatonnetDroit(plateau, ligne, colonne) < 2) {
                                cpt++;
                                tabbattonet[ligne][colonne] = 4;
                            }
                        }
                    }
                }
            ...
            if (cpt!=0) {
                do {
                    meilleureOptionLigne = rand.nextInt(plateau.length);
                    meilleureOptionColonne = rand.nextInt(plateau[0].length);
                } while (tabbattonet[meilleureOptionLigne][meilleureOptionColonne]!=4);
                aTrouveUnBonMouvement = true;
            }
        }
        ...
        if (!aTrouveUnBonMouvement) {
            ...
            for (int ligne = 0; ligne < plateau.length; ligne++) {
                for (int colonne = 0; colonne < plateau[ligne].length; colonne++) {
                    ...
                    if (ligne % 2 != colonne % 2 && plateau[ligne][colonne] == 0) {
                        ...
                        if (peutPlacerBatonnet(plateau, ligne, colonne) < 2) {
                            // Si aucun carr� n'est form�, v�rifier la possibilit� de placer un b�tonnet
                            cpt++;
                            tabbattonetcoins[ligne][colonne] = 4;
                        }
                    }
                }
            ...
            if (cpt!=0) {
                do {
                    meilleureOptionLigne = rand.nextInt(plateau.length);
                    meilleureOptionColonne = rand.nextInt(plateau[0].length);
                } while (tabbattonetcoins[meilleureOptionLigne][meilleureOptionColonne]!=4);
                aTrouveUnBonMouvement = true;
            }
        }
        ...
        if (!aTrouveUnBonMouvement) {
            ...
            // V�rifie si ligne colonne possible et que position == 0
        }
    ...
    // fonction qui permet de pr�visualiser le nombre de batonnets autour d'une case d'un carr� non form�
    public static int peutPlacerBatonnet(int[][] plateau, int ligne, int colonne) {
        int lignes = plateau.length;
        int colonnes = plateau[0].length;
        int exclusions = 0;
        ...
        // V�rifier si la ligne est paire et la colonne est impaire
        if (ligne % 2 == 0 && colonne % 2 == 1) {
            // V�rifier les exclusions cot� haut
            if (ligne - 2 >= 0 && colonne - 1 >= 0 && colonne + 1 < colonnes) {
                if (plateau[ligne - 1][colonne] == 0) {
                    if (plateau[ligne - 2][colonne] != 0) exclusions++;
                    if (plateau[ligne - 1][colonne - 1] != 0) exclusions++;
                    if (plateau[ligne - 1][colonne + 1] != 0) exclusions++;
                    if (exclusions<2) return exclusions;
                    else exclusions=0;
                }
            }
            // V�rifier les exclusions cot� bas
            else if (ligne + 2 < lignes && colonne - 1 >= 0 && colonne + 1 < colonnes) {
                if (plateau[ligne + 1][colonne] == 0) {
                    if (plateau[ligne + 2][colonne] != 0) exclusions++;
                    if (plateau[ligne + 1][colonne - 1] != 0) exclusions++;
        ...
        // V�rifier si la ligne est impaire et la colonne est paire
            ...
            // V�rifier les exclusions cot� gauche
            if (ligne - 1 >= 0 && colonne - 2 >= 0) {
                if (plateau[ligne][colonne - 1] == 0) {
                    if (plateau[ligne][colonne - 2] != 0) exclusions++;
                    if (plateau[ligne - 1][colonne - 1] != 0) exclusions++;
                    if (plateau[ligne + 1][colonne - 1] != 0) exclusions++;
                    if (exclusions<2) return exclusions;
                    else exclusions=0;
            ...
            // V�rifier les exclusions cot� droit
            else if (ligne + 1 < lignes && colonne + 2 < colonnes) {
                if (plateau[ligne][colonne + 1] == 0) {
                    if (plateau[ligne][colonne + 2] != 0) exclusions++;
                    if (plateau[ligne - 1][colonne + 1] != 0) exclusions++;
    ...
    // fonction qui permet de pr�visualiser le nombre de batonnets autour de la case du carr� au dessus du batonent � jouer par l'ia
    public static int peutPlacerBatonnetHaut(int[][] plateau, int ligne, int colonne) {
        int lignes = plateau.length;
        int colonnes = plateau[0].length;
        int exclusions = 0;
        // V�rifier si la ligne est paire et la colonne est impaire
    ...
    // fonction qui permet de pr�visualiser le nombre de batonnets autour de la case du carr� en dessous du batonent � jouer par l'ia
    public static int peutPlacerBatonnetBas(int[][] plateau, int ligne, int colonne) {
        int lignes = plateau.length;
        int colonnes = plateau[0].length;
        int exclusions = 0;
        // V�rifier si la ligne est paire et la colonne est impaire
        if (ligne % 2 == 0 && colonne % 2 == 1) {
            // V�rifier les exclusions cot� bas
            if (ligne + 2 < lignes && colonne - 1 >= 0 && colonne + 1 < colonnes) {
                if (plateau[ligne + 1][colonne] == 0) {
                    if (plateau[ligne + 2][colonne] != 0) exclusions++;
                    if (plateau[ligne + 1][colonne - 1] != 0) exclusions++;
                    if (plateau[ligne + 1][colonne + 1] != 0) exclusions++;
    ...
    // fonction qui permet de pr�visualiser le nombre de batonnets autour de la case du carr� � gauche du batonent � jouer par l'ia
    public static int peutPlacerBatonnetGauche(int[][] plateau, int ligne, int colonne) {
        int lignes = plateau.length;
        int colonnes = plateau[0].length;
        int exclusions = 0;
    ...
    // fonction qui permet de pr�visualiser le nombre de batonnets autour de la case du carr� � droite du batonent � jouer par l'ia
    public static int peutPlacerBatonnetDroit(int[][] plateau, int ligne, int colonne) {
        int lignes = plateau.length;
        int colonnes = plateau[0].length;
        int exclusions = 0;
        ...
        if (ligne % 2 == 1 && colonne % 2 == 0) {
            // V�rifier les exclusions cot� droit
            if (ligne + 1 < lignes && colonne + 2 < colonnes) {
                if (plateau[ligne][colonne + 1] == 0) {
                    if (plateau[ligne][colonne + 2] != 0) exclusions++;
                    if (plateau[ligne - 1][colonne + 1] != 0) exclusions++;
                    if (plateau[ligne + 1][colonne + 1] != 0) exclusions++;
